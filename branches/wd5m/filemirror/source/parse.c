...
notest:
/* fp=fopen("/home/irlp/custom/EchoIRLP/hosts","r"); */
fp=fopen("/home/EchoIRLP/tbd/data/hosts-all","r");
...
while (!feof(fp)) {
      ...
      sscanf(finline,"%s %s %s",parstr[1],parstr[2],parstr[3]);
